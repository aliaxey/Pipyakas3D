...
public class Constants {
    ...
    public const int CAMERA_OFFSET_Y = 2;
    public const float CAMERA_SPEED = 5f;
    public const float CAMERA_Z_DISTANCE = -15;
    //------------------------------------------
    public const float PIPYAKA_HELTH = 10;
    public const int WATERMELON_DISTANCE = 5;
    public const float WATERMELON_SPEED = 9f;
    //------------------------------------------
    public const string KEY_UP = "w";
    public const string KEY_DOWN = "s";
